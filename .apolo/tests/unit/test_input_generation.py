...
from apolo_apps_spark_job.inputs_processor import SparkJobInputsProcessor
...
async def test_spark_job_values_generation(setup_clients):
    processor = SparkJobInputsProcessor(client=setup_clients)
